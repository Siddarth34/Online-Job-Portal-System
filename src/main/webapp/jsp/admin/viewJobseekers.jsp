...
try {
    ...
    PreparedStatement ps = con.prepareStatement("SELECT * FROM users WHERE role='jobseeker' AND is_active = 1");
...
%>
    <tr>
        ...
        <td><%= rs.getString("experience_years") %></td>
        <td>
